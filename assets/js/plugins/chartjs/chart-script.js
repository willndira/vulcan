...
window.onload = function () {
    ...
    window.trendingLineChart = new Chart(trendingLineChart).Line(data, {
        ...
        scaleFontColor: "#ff6601",// String - Scale label font colour
    ...
    var doughnutChartsample = document.getElementById("doughnut-chart-sample").getContext("2d");
    window.myDoughnut = new Chart(doughnutChartsample).Doughnut(doughnutData, {
        segmentStrokeColor: "#fff",
        tooltipTitleFontFamily: "'Roboto','Helvetica Neue', 'Helvetica', 'Arial', sans-serif",// String - Tooltip title font declaration for the scale label
        percentageInnerCutout: 50,
        animationSteps: 15,
