    ...
    var O = function (h) {
        ...
        function Ha(a) {
            var b = a.aoColumns, c = a.aoData, e = m.ext.type.detect, d,
                f, g, i, j, h, l, q, o;
            d = 0;
            for (f = b.length; d < f; d++)if (l = b[d], o = [], !l.sType && l._sManualType)l.sType = l._sManualType; else if (!l.sType) {
                g = 0;
        ...
        function ib(a, b, c, e) {
            ...
            if (b)for (d = b.length - 1; 0 <= d; d--) {
                ...
                g; f++)if ("number" === typeof q[f] && 0 <= q[f]) {
                    ...
                    e(q[f], n)
                } else if ("number" === typeof q[f] && 0 > q[f])e(l.length + q[f], n); else if ("string" === typeof q[f]) {
                    i = 0;
        ...
        function y(a, b, c, e) {
            ...
            if ((c === g || null === c) &&
                null !== i)c = i; else if ("function" === typeof c)return c.call(g);
        ...
        function mb(a) {
            ...
            for (var f = a.sDom.split(""), g, i, j, n, l, q, o = 0; o < f.length; o++) {
                ...
                if ("<" == i) {
                    ...
                    d.append(j);
                    d = h(j)
                } else if (">" == i)d = d.parent(); else if ("l" == i && e.bPaginate && e.bLengthChange)g = nb(a); else if ("f" == i && e.bFilter)g = ob(a); else if ("r" == i && e.bProcessing)g = pb(a); else if ("t" == i)g = qb(a); else if ("i" ==
                    i && e.bInfo)g = rb(a); else if ("p" == i && e.bPaginate)g = sb(a); else if (0 !== m.ext.feature.length) {
                    j = m.ext.feature;
                    q = 0;
                    for (n = j.length; q < n; q++)if (i == j[q].cFeature) {
                        g = j[q].fnInit(a);
                        break
                    }
                }
            ...
            for (j = c.length; f < j; f++) {
                ...
                for (d = e.firstChild; d;) {
                    if ("TD" == d.nodeName.toUpperCase() || "TH" == d.nodeName.toUpperCase()) {
                        ...
                        n = g;
                        o = 1 === l ? !0 : !1;
                        for (i = 0; i < l; i++)for (g = 0; g < q; g++)a[f + g][n + i] = {cell: d, unique: o}, a[f + g].nTr = e
                    }
                    d = d.nextSibling
                }
            }
        ...
        function ob(a) {
            var b = a.oClasses, c = a.sTableId, e = a.oLanguage, d = a.oPreviousSearch, f = a.aanFeatures, g = '<input type="search" class="' + b.sFilterInput + '"/>', i = e.sSearch, i = i.match(/_INPUT_/) ? i.replace("_INPUT_", g) : i + g, b = h("<div/>", {
        ...
        function Ga(a) {
            ...
            if (!k && !f && !d && i == aa(a) && i == j.length)for (o = 0; o < i; o++)c[o].sWidth = s(j.eq(o).width()); else {
                ...
                if (a.aoData.length)for (o = 0; o < e.length; o++)k = e[o], m = c[k], h(Eb(a, k)).clone(!1).append(m.sContentPadding).appendTo(p);
                i.appendTo(l);
            ...
            if ("ssp" != B(a) && 0 !== n.length) {
                ...
                g === n.length ?
                    h.sort(function (a, b) {
                        ...
                        for (g = 0; g < i; g++)if (h = n[g], c = j[h.col], d = k[h.col], c = c < d ? -1 : c > d ? 1 : 0, 0 !== c)return "asc" === h.dir ? c : -c;
                        c = e[a];
                        d = e[b];
                        return c < d ? -1 : c > d ? 1 : 0
                    }) : h.sort(function (a, b) {
                    var c, g, h, i, j = n.length, k = f[a]._aSortData, m = f[b]._aSortData;
                    for (h = 0; h < j; h++)if (i = n[h], c = k[i.col], g = m[i.col], i = d[i.type + "-" + i.dir] || d["string-" + i.dir], c = i(c, g), 0 !== c)return c;
                    c = e[a];
                    g = e[b];
        ...
        function Ib(a, b) {
            ...
            e && (d = e.call(a.oInstance,
                a, b, $(a, b)));
            for (var f, g = m.ext.type.order[c.sType + "-pre"], h = 0, j = a.aoData.length; h < j; h++)if (c = a.aoData[h], c._aSortData || (c._aSortData = []), !c._aSortData[b] || e)f = e ? d[h] : y(a, h, b, "sort"), c._aSortData[b] = g ? g(f) : f
        }
        ...
        m = function (a) {
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase())R(null, 0, "Non-table node initialisation (" +
                    ...
                    if (d.aaData)for (g = 0; g < d.aaData.length; g++)J(p, d.aaData[g]); else(p.bDeferLoading || "dom" == B(p)) && ma(p, h(p.nTBody).children("tr"));
        ...
        t.prototype = {
            concat: v.concat, context: [], each: function (a) {
                ...
                h; g++) {
                    var p = new t(l[g]);
                    if ("table" === b)f = c.call(p, l[g], g), f !== k && d.push(f); else if ("columns" === b || "rows" === b)f = c.call(p, l[g], this[g], g), f !== k && d.push(f); else if ("column" === b || "column-rows" === b || "row" === b || "cell" === b) {
                        o = this[g];
        ...
        t.register = r = function (a, b) {
            if (h.isArray(a))for (var c = 0, e = a.length; c < e; c++)t.register(a[c], b); else for (var d = a.split("."), f = Tb, g, i, c = 0, e = d.length; c < e; c++) {
        ...
        r("cells()", function (a, b, c) {
            ...
            var e = this.columns(b, c), d = this.rows(a, c), f, g, i, j, n, l = this.iterator("table", function (a, b) {
                ...
                for (i = d[b].length; g < i; g++) {
                    j = 0;
                    for (n = e[b].length; j < n; j++)f.push({row: d[b][g], column: e[b][j]})
                }
                return f
            }, 1);
        ...
        m.defaults = {
            ...
            oLanguage: {
                ...
                sEmptyTable: "No records available to display",
