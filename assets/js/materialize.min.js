    ...
    a.fn.scrollTo = function (b) {
        ...
        this.each(function () {
            ...
            function e() {
                ...
                if (e + i.innerWidth() > a(window).width() ? f = "right" : e - i.innerWidth() + g.innerWidth() < 0 && (f = "left"), "left" === f)
                    ...
                    h = void 0 === h || "" === h ? c.delay : h, d = 0, f = setInterval(function () {
                        if (d += 10, d >= h && e === !1) {
                            ...
                            "top" === n ? (a = i.offset().top - o - g, c = i.offset().left + j / 2 - p / 2, f = b(c, a, p, o), q = "-10px", l.css({
                                ...
                                marginTop: o / 2,
                                marginLeft: "0px"
                            })) : (a = i.offset().top + i.outerHeight() + g, c = i.offset().left + j / 2 - p / 2, f = b(c, a, p, o), q = "+10px", l.css({marginLeft: p / 2 - l.width() / 2})), k.css({
                                top: f.y,
                                left: f.x
    ...
    a(document).ready(function () {
        ...
        a(this).each(function () {
            ...
            if (!d.hasClass("browser-default")) {
                ...
                var q = [], r = function (b) {
                    if (9 == b.which)
                        return void p.trigger("close");
                    if (40 == b.which && !j.is(":visible"))
                        return void p.trigger("open");
                ...
                f.hammer({prevent_default: !1}).bind("pan", function (a) {
                    if ("touch" === a.gesture.pointerType) {
                        ...
                        $curr_slide = g.find(".active"),
                                $curr_slide.velocity({translateX: c}, {
                                    duration: 50,
                                    queue: !1,
                                    easing: "easeOutQuad"
            ...
            a(this).hammer({prevent_default: !1}).bind("pan", function (d) {
                ...
                if (Math.abs(d.gesture.deltaX) < a(this).innerWidth() / 2 && (c = !1, b = !1), "touch" === d.gesture.pointerType) {
                    ...
                    if (b || c) {
                        ...
                        e.velocity({translateX: 0}, {duration: 100, queue: !1, easing: "easeOutQuad"});
                    b = !1, c = !1
                }
            })
        })
