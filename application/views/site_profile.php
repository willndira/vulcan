<div class="section">
    <div class="row">
        ...
        <div class="col s12 m7">
            ...
            <a href="#add-aps" class="btn modal-trigger blue right">
                Add APS
            </a>
        </div>
    ...
    <!------------------------------------------------APS------------------------------------------------------->
    <div id="add-aps" data-keyboard="false" class="modal bottom-sheet">
        <div class="modal-content" style="padding: 5px !important;">
            <ul class="collection">
                <li class="collection-item">
                    <h5 class="orange-text center">Add APS to <?= $details->site_name ?></h5>
                </li>
                <li class="collection-item">
                    <form class="col s12" method="post" action="<?= site_url('sites/add_aps') ?>">
                        <input type="hidden" name="site_id" value="<?= $details->site_id ?>" required/>
