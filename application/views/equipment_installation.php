...
$assembly_steps = $this->projects_model->equipment_steps($specs->component_id, 2);
    ...
    <div class="row">
        <div class="col s12 m8">
            <div class="row">
                ...
                <div class="col s12">
                    <?php
                    $installation = $this->equipment_model->installation_ready($specs->equipment_id);
                    if (!is_bool($installation)) {
                        $ready = false;
                        ?>
                        <div class="row">
                            <div class="col s12">
                                <div class="card orange lighten-2">
                                    <div class="card-content center">
                                        <strong>ATTENTION!!! </strong>Equipment installation will not be completed. Reason:
                    ...
                    <div class="row">
                        ...
                        <?php if ($is_pm && $specs->equipment_stage < 6) { ?>
                            <div class="col s6">
                                                ...
                                                <form
                                                    ...
                                                    <?php if ($task->schedule_stage != 2) { ?>
                                                        ...
                                                        <div class="input-field col s12">
                                                            <input type="hidden" name="redirect" value="/equipment/install/" required/>
                    ...
                    <ul class="collection with-header">
                        <li class="collection-item tab-content" id="i-required">
                            <table class="responsive-table display" cellspacing="0">
                                ...
                                <?php
                                $required = 0;
                                foreach ($this->components_model->assets($specs->component_id, 1) as $component) {
                                                    ...
                                                    <button class="ajax btn green right"
                                                            value="assets/request/<?= urlencode(base64_encode(json_encode(
                                                                array(
                                                                    ...
                                                                    "purpose" => 'installation requirement for <b>equipment no: ' . $specs->equipment_no . '</b>',
                                                                    "request_level" => 3,
                                                                    "request_category" => 2)
                                                            ))) ?>">
                                                        Request
        ...
        <div class="col s12 m4">
            <div class="col s12 right-align">
                <?php if ($procedure_complete && $tasks_complete && $is_pm && $ready && ($required <= count($assigned)) && $specs->equipment_stage < 6) { ?>
                    <button class="ajax btn white-text orange lighten-2" value="projects/assembly_complete/<?= $details->equipment_id ?>">
                        Complete installation
                    </button>
                <?php }
                if ($specs->equipment_stage > 5) {
                    ?>
                    <button id="assembly/report/<?= urlencode(base64_encode($details->equipment_assembly_id)) ?>/yes"
            ...
            <ul class="collection">
                ...
                <li class="collection-item center">
                    <h5 class="card-title ">
                        <?= $specs->equipment_stage < 6 ? $this->equipment_model->stage($specs->equipment_stage) : '<span class="green-text text-darken-4">COMPLETE :-)</span>' ?>
                    </h5>
                    Stage
                </li>
                <?php
                if ($specs->equipment_stage < 6) {
                    ?>
                    <li class="collection-item center">
                        <h5 class="card-title ">
                ...
                <li class="collection-item">
                    <div class="row">
                        <div class="col s10 center">
                            ...
                            <span class="black-text">Installation Manager </span>
                        </div>
...
<div id="new_task" data-keyboard="false" class="modal bottom-sheet">
    <div class="modal-content" style="padding: 5px !important;">
        <ul class="collection">
            <li class="collection-item">
                <h5 class="orange-text center">New installtion task</h5>
            </li>
            <li class="collection-item">
                <form method="post" action="<?= site_url('assembly/new_task/' . urlencode(base64_encode($details->equipment_assembly_id))) ?>">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            <input id="sdate" type="text" name="sdate" required/>
                            <label for="sdate">Expected Start date</label>
                        </div>
                        <div class="input-field col s6">
                            <input type="hidden" name="redirect" value="/equipment/install/" required/>
                            <input id="edate" type="text" name="edate" required/>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <select id="pm" multiple name="assigned_staff[]" data-placeholder="Assign staff this task"
                                ...
                                <?php foreach ($this->users_model->has_powers('install_equipment') as $pm) { ?>
                                    <option value="<?= $pm->user_id ?>"><?= $pm->user_name ?></option>
                                <?php } ?>
                            </select>
